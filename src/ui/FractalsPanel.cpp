...
void Render(AppState& state) {
    ...
    const auto& fractalAppearance = state.settings.Appearance(PanelKind::Fractals);
    ...
    const bool instabilitiesReady = state.instabilitiesDataReady;
    {
        ...
        fractalContentSize = GridLayout::ComputePlacement(
                                 fractalGroups, fractalAppearance.panelLayout,
                                 fractalAppearance.panelScale, fractalAppearance.groupLabelDisplay)
                                 .contentSize;
    }
    ...
    GridRenderer::DrawGroups(fractalGroups, state.settings, fractalAppearance,
                             state.settings.fractalsEnableTooltips, true, true, font, context);
